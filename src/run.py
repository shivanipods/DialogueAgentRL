...
from deep_dialog.agents import AgentCmd, InformAgent, RequestAllAgent, \
        ...
        AgentDQN, AgentDQNKeras, AgentDQNBoltzmann, AgentBBQN, AgentA2C, AgentAdverserialA2C, AgentSharedA2C
...
if __name__ == "__main__":
    ...
    parser.add_argument('--a2c_hidden_size', dest='a2c_hidden_size', type=int, default=50, help='the hidden size for A2C')
    ...
    parser.add_argument('--simulation_epoch_size', dest='simulation_epoch_size', type=int, default=5, help='the size of validation set')
...
def test_episodes(num_runs, status, is_a2c, agt):
    ...
    for i in range(num_runs):
        simulation_res, _, _, _ = simulation_epoch(num_episodes)
